...
export function setupWSConnection(ws, doc, roomName) {
    const awareness = new awarenessProtocol.Awareness(doc);
    const connection = { ws, awareness, doc };
...
function handleSyncMessage(decoder, _encoder, doc, ws, roomName) {
    const syncEncoder = encoding.createEncoder();
    encoding.writeVarUint(syncEncoder, MESSAGE_SYNC);
    const syncMessageType = syncProtocol.readSyncMessage(decoder, syncEncoder, doc, ws);
...
function handleAwarenessMessage(decoder, awareness, _roomName) {
